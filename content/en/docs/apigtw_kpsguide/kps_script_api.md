...
"date": "2020-01-06",
"description": "The KPS scripting API facilitates create, read, update, delete (CRUD) operations to KPS tables from your policies. You can use this API via a custom **Scripting Language** filter in Policy Studio."
}
﻿
...
-   [Configure KPS in Policy Studio](3_KPS_configuration.htm)
...
-   It is recommended that you set up Cassandra as detailed in the
...
[Scripting language filter](/csh?context=629&product=prod-api-gateway-77)
in the
