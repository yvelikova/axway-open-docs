{"title":"Manage an API proxy using AMPLIFY CLI","linkTitle":"Manage an API proxy using AMPLIFY CLI","date":"2019-7-30","description":"*Estimated reading time: 5 minutes* "} ﻿
