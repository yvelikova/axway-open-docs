...
You can configure how quota information is stored using Policy Studio in **Server Settings** > **API Manager** > **Quota Settings**. For more details, see [Quota Settings.](/docs/apimgr_admin/api_mgmt_config_ps/#quota-settings)
...
For details on managing applications, see [Manage client applications](/docs/apimgr_admin/api_mgmt_consume/#manage-client-applications).
