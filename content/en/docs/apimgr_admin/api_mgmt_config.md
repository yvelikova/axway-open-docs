...
5. Configure additional API Manager settings under **Server Settings > API Manager**. For example, you can specify custom policies that are called as traffic passes through API Manager. For more details, see [Configure API Manager settings in Policy Studio](http:///docs/apimgr_admin/api_mgmt_config_ps/).
...
For more details, see [Monitor APIs and applications in API Manager](/docs/apimgr_admin/api_mgmt_monitor/).
