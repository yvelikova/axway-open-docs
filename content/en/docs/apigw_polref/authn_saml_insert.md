{
"title": "Insert SAML authentication assertion",
"linkTitle": "Insert SAML authentication assertion",
"date": "2019-10-17",
"description": "After successfully authenticating a client, the API Gateway can insert a SAML (Security Assertion Markup Language) authentication assertion into the SOAP message. Assuming all other security filters in the policy are successful, the assertion is eventually consumed by a downstream web service."
}
﻿
<div id="p_authn_saml_insert_overview">
...
<div id="p_authn_saml_insert_assertion_details">
...
<div id="p_authn_saml_insert_assertion_location">
...
<div id="p_authn_saml_insert_assertion_confirm">
...
<div id="p_authn_saml_insert_advanced">
