...
Click to load the user certificate from the **Certificate Store**. For details on how to create and import certificates, see [Manage X.509 certificates and keys](/docs/apim_administration/apigtw_security/general_certificates).
