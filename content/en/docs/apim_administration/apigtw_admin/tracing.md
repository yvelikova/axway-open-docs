...
For details on how to redact sensitive data from trace files (for example, user passwords or credit card details), see [Hide sensitive data in API Gateway Manager](/docs/apim_administration/apigtw_security/admin_redactors). The trace level you set impacts the redaction.
