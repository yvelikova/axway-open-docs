...
{{< alert title="Note" color="primary" >}}`apply` does not update the metrics database. For more details, see [Upgrade API Gateway Analytics](/docs/apigw_upgrade/upgrade_analytics/) or [Upgrade metrics database for API Manager](/docs/apigw_upgrade/upgrade_metrics/).{{< /alert >}}
