...
For more details on performing an upgrade, see [Upgrade from API Gateway 7.5.x or 7.6.x](/docs/apigw_upgrade/upgrade_steps_extcass/).
...
For details on all commands and options, see [sysupgrade command reference](/docs/apigw_upgrade/upgrade_script/).
