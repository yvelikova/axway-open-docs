...
* If you have an existing API Portal installation earlier than 7.7, you can upgrade that installation to a newer version without having to repeat the initial setup.

Note: Upgrade to API Portal 7.7 is supported from API Portal 7.6.2 only. To upgrade from earlier versions, you must first upgrade to 7.6.2.

* If you have an existing 7.7.x API Portal installation, you can upgrade that installation to a newer version without having to repeat the initial setup.

  Upgrade paths: 

  * 7.6.2 to 7.7 GA

  * 7.7 GA to 7.7.x (including all Service Packs )
