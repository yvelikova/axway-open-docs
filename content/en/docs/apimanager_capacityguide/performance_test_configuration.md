...
date: 2019-09-26
description: The API Management performance tests were run both single node configuration and multi-node high availability (HA) configuration. Apache Cassandra 2.2.12 instances were used as the backing data store. In the HA configuration, both local Cassandra and remote Cassandra were tested.
weight: "2"
---
...
The following sections describe the test configurations in more detail:

* [Single node configuration](#Single)
* [Multi-node HA configuration with local Cassandra](#Multinod)
* [Multi-node HA configuration with remote Cassandra](#Multinod2)
