...
6.  For API Gateway to establish the SSL connection to the firewall, the specified `opsec_sslca_file` must be uploaded to API Gateway. To do this, click **Add** and select the correct file.
7.  Click **OK**.
