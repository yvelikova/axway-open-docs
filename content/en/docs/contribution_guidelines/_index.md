...
6. When you are finished making changes, change the status of the content to **In review**. This creates a pull request, which enables us to review the changes you made on your fork using Netlify CMS and _pull_ them into the original Axway repository.
    ...
    * Please go to GitHub and add a comment to the pull request describing your changes, as there is currently no ability in Netlify CMS to tell us what you changed and why.
    * To preview your changes exactly as they will appear on the live website, click the deploy preview link in the pull request.

## Additional resources

* [Write with Markdown for Axway-Open-Docs](/docs/contribution_guidelines/writing_markdown/)
