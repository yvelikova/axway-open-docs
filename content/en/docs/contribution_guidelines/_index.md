...
3. Make your changes on the WYSIWYG editor on the left. You can check the formatting in the live preview on the right side.

    ![WYSIWYG editor](/Images/contributing/netlify_WYSIWYGeditor.png)

4. When you are finished making changes, click **Save**.
5. Change the status of the content to **In review**.
...
When you change the status of the content to **In review** this creates a pull request in the background and it sends two emails to you and to the Technical Writers: one email generated by Netlify CMS with a link for the pull request created on GitHub and another email with a link to a preview website where you can check your changes.

To ensure that we have all the information we need to review your changes, go to GitHub and add a comment to the pull request, as there is currently no ability in Netlify CMS to tell us what you changed and why.
