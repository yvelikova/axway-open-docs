...
| RDAPI-18519 | 01108119  01110455                                                                                 | **Issue**: The API Manager UI is too slow when using SSO. **Resolution**:  API Manager UI performance is improved by using existing data cache of users when querying for a user by DN.                                                                                                                                                                                                                                                                                      |
