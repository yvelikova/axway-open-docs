...
For details on setting trace levels, and running a startup trace, see [Set API Gateway trace levels](/docs/apigtw_admin/tracing#set-api-gateway-trace-levels).
